...
from models.regression.transformer_vae import TransformerVAE, TransformerVAELoss
...
# #----------------------------------------------
    ...
    for batch_ind, batch_arrays in enumerate(test_dataloader):
        ...
        output_list.append(labels_from_history.detach().cpu())
