...
def launch():
    ...
    prepared_folder, model_name, look_back, emb_dim, rand_seed, result_name = base_dict["prepared_folder"], base_dict["model_name"], \
        base_dict["look_back"], base_dict["emb_dim"], base_dict["rand_seed"], base_dict["result_name"]
    ...
    checkpoint = os.path.join('checkpoints/', dataset_name, model_name, f'checkpoint_{result_name}.pt')
...
#------------------------------------------------------
    ...
    with open(os.path.join('results/', dataset_name, model_name, f'metrics_{result_name}.json'), 'w', encoding='utf-8') as f:
